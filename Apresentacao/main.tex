...
\usepackage[space]{grffile} %pra poder incluir arquivos em diretórios que tem ESPAÇO no nome

\pgfplotsset{
	yticklabel style={compat=1.3,align=right}
}
%----------------------------------------------------------------------------------------
%   TITLE PAGE
%----------------------------------------------------------------------------------------

\title[IoT]{ROTEAMENTO SENSÍVEL AO CONTEXTO} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Grupo 4} % Your name
...
\date{Brasília, junho  de 2017} % Date, can be changed to a custom date
...
{\tiny
  ...
  \bibliography{sample}   % expects file "bibliography.bib" 
  }
